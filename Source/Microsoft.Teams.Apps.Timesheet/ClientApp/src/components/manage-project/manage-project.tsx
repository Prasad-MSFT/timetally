// <copyright file="manage-project.tsx" company="Microsoft">
...
class ManageProject extends React.Component<IManageProjectProps, IManageProjectState> {
    ...
    constructor(props: any) {
        ...
        this.params.projectId = params.get("projectId")!;
        this.params.userObjectId = params.get("userObjectId")!;
        this.params.isMobileView = params.get("isMobileView")! === "true" ? true : false;
        ...
        this.state = {
            ...
            projectDetails: {
                ...
                underutilizedNonBillableHours: 0,
                underutilizedBillableHours: 0,
                totalHours: 0,
    ...
    onRemoveTasks = async (selectedTasks: Array<IProjectTaskOverview>) => {
        ...
        if (response.status === ResponseStatus.NoContent) {
            selectedTasks.map((selectedTask: any) => {
    ...
    /**
     * Invoked when user remove request and update the request state.
     */
