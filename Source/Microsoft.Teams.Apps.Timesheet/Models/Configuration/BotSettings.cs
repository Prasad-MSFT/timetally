...
namespace Microsoft.Teams.Apps.Timesheet.Models
{
    ...
    public class BotSettings : BotOptions
    {
        ...
        /// <summary>
        /// Gets or sets cache duration for which information to be stored in cache indicating whether a logged-in user
        /// is part of any projects.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets cache duration for caching validation result for checking whether manager has at least one reportee.
        /// </summary>
