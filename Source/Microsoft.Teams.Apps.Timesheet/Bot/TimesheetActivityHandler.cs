// <copyright file="TimesheetActivityHandler.cs" company="Microsoft">
...
namespace Microsoft.Teams.Apps.Timesheet.Bot
{
    ...
    {
        /// <summary>
        /// A set of key/value bot activity handler properties.
        /// </summary>
        private readonly IOptions<TimesheetActivityHandlerOptions> options;
        ...
        public TimesheetActivityHandler(
            ...
            IOptions<TimesheetActivityHandlerOptions> options,
        ...
        /// </remarks>
#pragma warning disable CS1998 // Lifecycle method of Bot framework.
        protected override async Task OnMessageActivityAsync(ITurnContext<IMessageActivity> turnContext, CancellationToken cancellationToken)
#pragma warning restore CS1998 // Lifecycle method of Bot framework.
        {
            turnContext = turnContext ?? throw new ArgumentNullException(nameof(turnContext));

            this.RecordEvent(nameof(this.OnMessageActivityAsync), turnContext);

            var textContents = this.options.Value.IsUpperCaseResponse ? turnContext.Activity.Text.ToUpperInvariant() : turnContext.Activity.Text;

            // TODO: handle message activity
        }
