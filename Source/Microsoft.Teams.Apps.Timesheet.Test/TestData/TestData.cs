...
namespace Microsoft.Teams.Apps.Timesheet.Tests.TestData
{
    ...
    public static class TestData
    {
        ...
        /// </summary>
        public static readonly List<Member> InvalidMembers = new List<Member>
        {
            new Member
            {
        ...
        /// <summary>
        /// Expected submitted request DTO to be verify in test.
        /// </summary>
        public static readonly List<List<DateTime>> ExpectedDateRange = new List<List<DateTime>>
        {
            new List<DateTime>
            {
        ...
        /// </summary>
        public static readonly List<TimesheetEntity> SavedTimesheets = new List<TimesheetEntity>
        {
            new TimesheetEntity
            {
                Id = Guid.NewGuid(),
        ...
        /// Expected submitted request DTO to be verify in test.
        /// </summary>
        public static readonly List<SubmittedRequestDTO> ExpectedSubmittedRequestDTO = new List<SubmittedRequestDTO>
        {
        ...
        /// <summary>
        /// Result reponse object with OK status for testing.
        /// </summary>
        public static readonly ResultResponse OKResultResponse = new ResultResponse
        {
        ...
        /// </summary>
        public static readonly List<UserTimesheet> UserTimesheets = new List<UserTimesheet>
        {
            new UserTimesheet
            {
        ...
        /// Timesheet test list.
        /// </summary>
        public static readonly List<TimesheetEntity> Timesheets = new List<TimesheetEntity>
        {
            new TimesheetEntity
            {
            ...
            {
                // Given same date as given in user timesheet test list.
                TimesheetDate = new DateTime(2020, 12, 10),
                TaskId = Guid.Parse("1eec371f-edbe-4ad1-be1d-d4cd3515540e"),
                Id = Guid.Parse("1eec371f-edbe-4ad1-be1d-d4cd3515541e"),
                Status = (int)TimesheetStatus.None,
                Task = new TaskEntity
        ...
        /// </summary>
        public static readonly List<Project> AllProjectsAssignedToUser = new List<Project>()
        {
            new Project
            {
                Id = Guid.Parse("1eec371f-edbe-4ad1-be1d-d4cd3515541e"),
        ...
        /// Project test model.
        /// </summary>
        public static readonly ProjectDTO ProjectDTO = new ProjectDTO
        {
            BillableHours = 50,
            NonBillableHours = 10,
            ClientName = "Samuel,",
        ...
        /// <summary>
        /// Project update test model.
        /// </summary>
        public static readonly ProjectUpdateDTO ProjectUpdateModel = new ProjectUpdateDTO
        {
            BillableHours = 50,
            NonBillableHours = 10,
            ClientName = "Samuel,",
            StartDate = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day),
            EndDate = new DateTime(DateTime.Now.Year, DateTime.Now.Month + 1, DateTime.Now.Day),
            Id = Guid.Empty,
            Title = "Project 1",
        };
        ...
        /// </summary>
        public static readonly List<TimesheetEntity> ApprovedTimesheets = new List<TimesheetEntity>
        {
            new TimesheetEntity
            {
                Id = Guid.NewGuid(),
        ...
        /// Tasks test list.
        /// </summary>
        public static readonly List<TaskEntity> Tasks = new List<TaskEntity>
        {
            new TaskEntity
            {
                Id = Guid.Parse("82ab7412-f6c1-491d-be16-f797e6903123"),
        ...
        /// <summary>
        /// Random reportee test list.
        /// </summary>
        public static readonly List<User> RandomReportees = new List<User>
        {
            new User
            {
