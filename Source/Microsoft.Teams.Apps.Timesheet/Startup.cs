...
#pragma warning restore CA1062 // The 'timesheetContext' will be available through dependency injection.
        ...
        private void ValidateConfigurationSettings()
        {
            ...
            if (this.configuration.GetValue<int?>("App:DailyEffortsLimit") == null || this.configuration.GetValue<int>("App:DailyEffortsLimit") < 1)
            {
                throw new ApplicationException("Invalid daily efforts value in configuration file. The value must be at least 1 hour.");
            }
