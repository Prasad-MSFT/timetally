// <copyright file="IProjectMapper.cs" company="Microsoft">
...
namespace Microsoft.Teams.Apps.Timesheet.ModelMappers
{
    ...
    public interface IProjectMapper
    {
        ...
        ProjectUtilizationDTO MapForProjectUtilizationViewModel(Project project, List<TimesheetEntity> timesheets, List<Member> members);
    }
}