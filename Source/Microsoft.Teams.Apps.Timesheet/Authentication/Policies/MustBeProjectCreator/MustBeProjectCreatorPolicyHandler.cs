// <copyright file="MustBeProjectCreatorPolicyHandler.cs" company="Microsoft">
...
namespace Microsoft.Teams.Apps.Timesheet.Authentication
{
    ...
    public class MustBeProjectCreatorPolicyHandler : IAuthorizationHandler
    {
        ...
        public async Task HandleAsync(AuthorizationHandlerContext context)
        {
            ...
            foreach (var requirement in context.Requirements)
            {
                if (requirement is MustBeProjectCreatorRequirement)
                {
                    ...
                    var isValuePresent = this.httpContextAccessor.HttpContext.Request.RouteValues.TryGetValue("projectId", out object projectIdFromRoute);
        ...
        {
            return $"_manager{userAadObjectId}$project{projectId}";
        }
    }
}
