// <copyright file="TimesheetLocalizationCultureProvider.cs" company="Microsoft">
...
namespace Microsoft.Teams.Apps.Timesheet.Bot
{
    ...
    /// <summary>
    /// The TimesheetLocalizationCultureProvider is responsible for implementing the <see cref="IRequestCultureProvider"/> for Bot Activities
    /// received from BotFramework.
    /// </summary>
    internal sealed class TimesheetLocalizationCultureProvider : IRequestCultureProvider
    {
        /// <summary>
