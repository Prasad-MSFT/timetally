...
namespace Microsoft.Teams.Apps.Timesheet.Repositories
{
    ...
    public class TimesheetRepository : BaseRepository<TimesheetEntity>, ITimesheetRepository
    {
        ...
        /// <returns>Returns the list of timesheet requests.</returns>
        public Dictionary<Guid, List<TimesheetEntity>> GetTimesheetRequestsByManager(Guid managerId, TimesheetStatus timesheetStatus)
        {
            return this.Context.Timesheets
                ...
                .ToDictionary(timesheet => timesheet.Key, timesheet => timesheet.ToList());
        }
        ...
        public IEnumerable<TimesheetEntity> GetTimesheetRequestsByProjectId(Guid projectId, TimesheetStatus timesheetStatus, DateTime startDate, DateTime endDate)
        {
            ...
            return this.Context.Timesheets
                ...
                .Include(timesheet => timesheet.Task.MemberMapping);
        }
        ...
        public IEnumerable<TimesheetEntity> GetTimesheetRequestsByProjectIds(IEnumerable<Guid> projectIds, TimesheetStatus timesheetStatus, DateTime startDate, DateTime endDate)
        {
            ...
            return this.Context.Timesheets
                .Where(timesheet => projectIds.Contains(timesheet.Task.ProjectId) && timesheet.Status == status && timesheet.TimesheetDate >= startDate.Date && timesheet.TimesheetDate.Date <= endDate.Date)
                .Include(timesheet => timesheet.Task);
        }
        ...
        {
            return this.Context.Timesheets.Where(timesheet => timesheet.TaskId == taskId && timesheet.Status == (int)timesheetStatus && timesheet.TimesheetDate >= startDate.Date && timesheet.TimesheetDate.Date <= endDate.Date);
        }
        ...
        /// <returns>Returns the list of timesheet requests.</returns>
        public Dictionary<Guid, List<TimesheetEntity>> GetTimesheetRequestsOfUsersByStatus(List<Guid> userObjectIds, TimesheetStatus status)
        {
            return this.Context.Timesheets
