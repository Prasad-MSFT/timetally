    ...
    public static class AuthenticationServiceCollectionExtensions
    {
        ...
        private static void RegisterAuthorizationPolicy(IServiceCollection services)
        {
            services.AddAuthorization(options =>
            {
                ...
                var mustBeValidReporteePolicyRequirement = new MustBeValidReporteePolicyRequirement();
                options.AddPolicy(
                    PolicyNames.MustBeValidReporteePolicy,
                    policyBuilder => policyBuilder.AddRequirements(mustBeValidReporteePolicyRequirement));
            });
            ...
            services.AddTransient<IAuthorizationHandler, MustBeValidReporteePolicyHandler>();
        }
