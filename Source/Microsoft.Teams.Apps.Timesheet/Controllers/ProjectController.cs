...
namespace Microsoft.Teams.Apps.Timesheet.Controllers
{
    ...
    public class ProjectController : BaseController
    {
        ...
        /// <summary>
        /// The instance of repository accessor to access particular repository.
        /// </summary>
        ...
        public IActionResult GetProject(Guid id)
        {
            ...
            try
            {
                var projectDetails = this.projectHelper.GetProjectById(id, Guid.Parse(this.UserAadId));
        ...
        /// <returns>Returns updated project details.</returns>
        [HttpPatch("{projectId}")]
        [Authorize(PolicyNames.MustBeManagerPolicy)]
        [Authorize(PolicyNames.MustBeProjectCreatorPolicy)]
...
#pragma warning restore CA1062 // Null check is handled by data annotations.
        ...
        [HttpDelete("{projectId}/member/tasks/{taskId}")]
        [Authorize(Policy = PolicyNames.MustBeProjectMemberPolicy)]
        public async Task<IActionResult> DeleteMemberTaskAsync(Guid projectId, Guid taskId)
        {
            ...
            try
            {
                var deletionResult = await this.taskHelper.DeleteMemberTaskAsync(taskId, Guid.Parse(this.UserAadId), projectId);

                if (deletionResult.StatusCode == HttpStatusCode.NoContent)
                {
                ...
                this.RecordEvent("Delete member task- The HTTP DELETE call to delete member task has been failed.", RequestType.Failed);
                return this.StatusCode((int)HttpStatusCode.InternalServerError, deletionResult.ErrorMessage);
            }
            catch (Exception ex)
            {
                this.RecordEvent("Delete member task- The HTTP DELETE call to delete member task has been failed.", RequestType.Failed);
        ...
        [Authorize(PolicyNames.MustBeManagerPolicy)]
        [Authorize(PolicyNames.MustBeProjectCreatorPolicy)]
        public IActionResult GetProjectUtilization(Guid projectId, [FromQuery] DateTime startDate, [FromQuery] DateTime endDate)
        {
            ...
            try
            {
                var projectUtilization = this.projectHelper.GetProjectUtilization(projectId, this.UserAadId, startDate.Date, endDate.Date);
        ...
        public async Task<IActionResult> DeleteMembersFromProjectAsync(Guid projectId, [FromBody] IEnumerable<ProjectMemberOverviewDTO> members)
        {
            ...
            try
            {
                ...
                var operationResult = await this.projectHelper.DeleteProjectMembersAsync(projectMembers.ToList());
        ...
        public async Task<IActionResult> DeleteTasksFromProjectAsync(Guid projectId, [FromBody] IEnumerable<Guid> taskIds)
        {
            ...
            try
            {
                ...
                var operationResult = await this.projectHelper.DeleteProjectTasksAsync(projectTasks.ToList());
        ...
        [Authorize(PolicyNames.MustBeManagerPolicy)]
        [Authorize(PolicyNames.MustBeProjectCreatorPolicy)]
        public IActionResult GetProjectMembersOverview(Guid projectId, [FromQuery] DateTime startDate, [FromQuery] DateTime endDate)
        {
            ...
            try
            {
                var membersOverview = this.projectHelper.GetProjectMembersOverview(projectId, startDate.Date, endDate.Date);
        ...
        [Authorize(PolicyNames.MustBeManagerPolicy)]
        [Authorize(PolicyNames.MustBeProjectCreatorPolicy)]
        public IActionResult GetProjectTasksOverview(Guid projectId, [FromQuery] DateTime startDate, [FromQuery] DateTime endDate)
        {
            ...
            try
            {
                var taskOverview = this.projectHelper.GetProjectTasksOverview(projectId, startDate.Date, endDate.Date);
        ...
        [HttpGet("dashboard")]
        [Authorize(PolicyNames.MustBeManagerPolicy)]
        public IActionResult GetDashboardProjects([FromQuery] DateTime startDate, [FromQuery] DateTime endDate)
        {
            ...
            try
            {
                ...
                var dashboardProjects = this.managerDashboardHelper.GetDashboardProjects(Guid.Parse(this.UserAadId), startDate.Date, endDate.Date);
                if (dashboardProjects.IsNullOrEmpty())
                {
                    this.RecordEvent("Get dashboard projects- The HTTP call to GET dashboard projects has been failed.", RequestType.Failed);
                    return this.NotFound(new ErrorResponse { Message = "Project not found." });
                }
        ...
        [HttpGet("users/{reporteeId}")]
        public async Task<IActionResult> GetProjectsAsync(Guid reporteeId, [FromQuery] DateTime calendarStartDate, [FromQuery] DateTime calendarEndDate)
        {
            ...
            if (calendarEndDate < calendarStartDate)
            {
                ...
                this.RecordEvent("Get projects- The HTTP call to GET projects details of user has been failed.", RequestType.Failed);
            ...
            try
            {
                ...
                var matchedReportee = reportees.Where(reportee => reportee.Id == reporteeId.ToString()).First();

                if (matchedReportee == null)
                {
                ...
                var activeProjects = await this.timesheetHelper.GetTimesheetsAsync(calendarStartDate, calendarEndDate, userObjectId: reporteeId);
                this.RecordEvent("Get projects- The HTTP call to GET projects details of user has been succeeded.", RequestType.Succeeded);

                return this.Ok(activeProjects);
            }
            catch (Exception ex)
            {
                this.RecordEvent("Get projects- The HTTP call to GET projects details of user has been failed.", RequestType.Failed);
